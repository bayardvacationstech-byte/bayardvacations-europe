;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="2cddcbc9-8039-1fb1-89af-405254758485")}catch(e){}}();
module.exports = [
...
class TraceTreeBuilder {
    ...
    constructor(options){
        ...
        if (!sendErrors || 'masked' in sendErrors) {
            this.transformError = ()=>new __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLError"]('<masked>', {
                    extensions: {
                        maskedBy
                    }
                });
    ...
    transformAndNormalizeError(err) {
        if (this.transformError) {
            ...
            if (!(rewrittenError instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLError"])) {
                return err;
            }
            return new __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLError"](rewrittenError.message, {
                nodes: err.nodes,
                source: err.source,
...
function defaultSendOperationsAsTrace() {
    const cache = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lru$2d$cache$2f$dist$2f$esm$2f$node$2f$index$2e$min$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LRUCache"]({
...
function createOperationDerivedDataCache({ logger }) {
    let lastWarn;
    let lastDisposals = 0;
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lru$2d$cache$2f$dist$2f$esm$2f$node$2f$index$2e$min$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LRUCache"]({
        sizeCalculation (obj) {
...
const packageVersion = "5.5.0"; //# sourceMappingURL=packageVersion.js.map
}),
...
function schemaIsSubgraph(schema) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["isObjectType"])(serviceType)) {
        return false;
    }
    ...
    if ((0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["isNonNullType"])(sdlFieldType)) {
        sdlFieldType = sdlFieldType.ofType;
    }
    if (!(0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["isScalarType"])(sdlFieldType)) {
        return false;
    }
...
//# debugId=2cddcbc9-8039-1fb1-89af-405254758485
//# sourceMappingURL=node_modules_2db6d3ad._.js.map