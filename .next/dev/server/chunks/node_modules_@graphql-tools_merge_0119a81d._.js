;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="d4bcf4a6-e703-3fa4-7330-a58fd97e83bf")}catch(e){}}();
module.exports = [
...
function extractLinks(typeDefs) {
    ...
    for (const definition of typeDefs.definitions){
        if (definition.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].SCHEMA_EXTENSION || definition.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].SCHEMA_DEFINITION) {
...
function linkFromArgs(args) {
    ...
    for (const arg of args){
        switch(arg.name.value){
            case 'url':
                {
                    if (arg.value.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].STRING) {
 ...
 */ function linkFromCoreArgs(args) {
    const feature = args.find(({ name, value })=>name.value === 'feature' && value.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].STRING);
    if (feature) {
...
function parseImportNode(node) {
    if (node.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].LIST) {
        const imports = node.values.map((v)=>{
            let namedImport;
            if (v.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].STRING) {
                namedImport = {
                    name: v.value
                };
            } else if (v.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].OBJECT) {
                let name = '';
                let as;
                for (const f of v.fields){
                    if (f.name.value === 'name') {
                        if (f.value.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].STRING) {
                            name = f.value.value;
                        }
...
const matchValues = (a, b)=>{
    if (a.kind === b.kind) {
        switch(a.kind){
            case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].LIST:
                return a.values.length === b.values.length && a.values.every((aVal)=>b.values.find((bVal)=>matchValues(aVal, bVal)));
            case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].VARIABLE:
            case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].NULL:
                return true;
            case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].OBJECT:
...
function isSourceTypes(types) {
    return types instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Source"];
}
function extractType(type) {
    let visitedType = type;
    while(visitedType.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].LIST_TYPE || visitedType.kind === 'NonNullType'){
        visitedType = visitedType.type;
    }
    return visitedType;
}
function isWrappingTypeNode(type) {
    return type.kind !== __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].NAMED_TYPE;
}
function isListTypeNode(type) {
    return type.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].LIST_TYPE;
}
function isNonNullTypeNode(type) {
    return type.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].NON_NULL_TYPE;
}
...
function mergeSchemaDefs(node, existingNode, config, directives) {
    if (existingNode) {
        return {
            kind: node.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].SCHEMA_DEFINITION || existingNode.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].SCHEMA_DEFINITION ? __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].SCHEMA_DEFINITION : __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].SCHEMA_EXTENSION,
            description: node['description'] || existingNode['description'],
            directives: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$graphql$2d$tools$2f$merge$2f$esm$2f$typedefs$2d$mergers$2f$directives$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mergeDirectives"])(node.directives, existingNode.directives, config, directives),
    ...
    return config?.convertExtensions ? {
        ...node,
        kind: __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].SCHEMA_DEFINITION
    } : node;
}
}),
...
function mergeUnion(first, second, config, directives) {
    if (second) {
        return {
            ...
            kind: config?.convertExtensions || first.kind === 'UnionTypeDefinition' || second.kind === 'UnionTypeDefinition' ? __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].UNION_TYPE_DEFINITION : __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].UNION_TYPE_EXTENSION,
            loc: first.loc,
...
function mergeGraphQLNodes(nodes, config, directives = {}) {
    ...
    for (const nodeDefinition of nodes){
        if (isNamedDefinitionNode(nodeDefinition)) {
            ...
            if (config?.exclusions?.includes(name + '.*') || config?.exclusions?.includes(name)) {
                ...
                switch(nodeDefinition.kind){
                    case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].OBJECT_TYPE_DEFINITION:
                    case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].OBJECT_TYPE_EXTENSION:
                        ...
                        break;
                    case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].ENUM_TYPE_DEFINITION:
                    case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].ENUM_TYPE_EXTENSION:
                        ...
                        break;
                    case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].UNION_TYPE_DEFINITION:
                    case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].UNION_TYPE_EXTENSION:
                        ...
                        break;
                    case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].SCALAR_TYPE_DEFINITION:
                    case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].SCALAR_TYPE_EXTENSION:
                        ...
                        break;
                    case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].INPUT_OBJECT_TYPE_DEFINITION:
                    case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].INPUT_OBJECT_TYPE_EXTENSION:
                        ...
                        break;
                    case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].INTERFACE_TYPE_DEFINITION:
                    case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].INTERFACE_TYPE_EXTENSION:
                        ...
                        break;
                    case __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].DIRECTIVE_DEFINITION:
        ...
        } else if (nodeDefinition.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].SCHEMA_DEFINITION || nodeDefinition.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].SCHEMA_EXTENSION) {
...
function visitTypeSources(typeSource, options, allDirectives = [], allNodes = [], visitedTypeSources = new Set(), repeatableLinkImports = new Set()) {
    ...
    if (typeSource && !visitedTypeSources.has(typeSource)) {
        ...
        if (typeof typeSource === 'function') {
        ...
        } else if ((0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["isSchema"])(typeSource)) {
            ...
            const documentNode = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["parse"])(typeSource, options);
            visitTypeSources(documentNode.definitions, options, allDirectives, allNodes, visitedTypeSources, repeatableLinkImports);
        } else if (typeof typeSource === 'object' && (0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["isDefinitionNode"])(typeSource)) {
            ...
            if (typeSource.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].DIRECTIVE_DEFINITION) {
...
//# debugId=d4bcf4a6-e703-3fa4-7330-a58fd97e83bf
