;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="8f765eb2-09da-8c36-04da-b1c6c1b3dfb7")}catch(e){}}();
module.exports = [
...
function unwrapResolverError(error) {
    if (error instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLError"] && error.path && error.originalError) {
...
;
;
class GraphQLErrorWithCode extends __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLError"] {
...
function ensureQueryIsStringOrMissing(query) {
    ...
    if (query.kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].DOCUMENT) {
...
function ensureError(maybeError) {
    return maybeError instanceof Error ? maybeError : new __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLError"]('Unexpected error value: ' + String(maybeError));
}
function ensureGraphQLError(maybeError, messagePrefixIfNotGraphQLError = '') {
    const error = ensureError(maybeError);
    return error instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLError"] ? error : new __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLError"](messagePrefixIfNotGraphQLError + error.message, {
        originalError: error
    });
}
...
function enablePluginsForSchemaResolvers(schema) {
    ...
    Object.values(typeMap).forEach((type)=>{
        if (!(0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["getNamedType"])(type).name.startsWith('__') && type instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLObjectType"]) {
...
function wrapField(field) {
    ...
    field.resolve = (source, args, contextValue, info)=>{
        ...
        const fieldResolver = originalFieldResolve || userFieldResolver || __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["defaultFieldResolver"];
        try {
...
async function tryToLoadGraphQL17() {
    ...
    const graphql = await __turbopack_context__.A("[externals]/graphql [external] (graphql, cjs, async loader)");
...
async function executeIncrementally({ useLegacyIncremental, legacyExperimentalExecuteIncrementally, ...args }) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["execute"])(args);
...
function isBadUserInputGraphQLError(error) {
    return error.nodes?.length === 1 && error.nodes[0].kind === __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["Kind"].VARIABLE_DEFINITION && (error.message.startsWith(`Variable "$${error.nodes[0].variable.name.value}" has invalid value`) || error.message.startsWith(`Variable "$${error.nodes[0].variable.name.value}" got invalid value `) || error.message.startsWith(`Variable "$${error.nodes[0].variable.name.value}" of required type `) || error.message.startsWith(`Variable "$${error.nodes[0].variable.name.value}" of non-null type `));
}
async function processGraphQLRequest(schemaDerivedData, server, internals, requestContext) {
    ...
    if (extensions?.persistedQuery) {
        if (!internals.persistedQueries) {
            ...
            return await sendErrorResponse([
                new __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLError"]('Unsupported persisted query version', {
                    extensions: {
                        http: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$runHttpQuery$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["newHTTPGraphQLHead"])(400)
                    }
                })
        ...
        if (query === undefined) {
            ...
            if (queryHash !== computedQueryHash) {
                return await sendErrorResponse([
                    new __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLError"]('provided sha does not match query', {
                        extensions: {
                            http: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$runHttpQuery$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["newHTTPGraphQLHead"])(400)
                        }
                    })
    ...
    if (!requestContext.document) {
        ...
        try {
            requestContext.document = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["parse"])(query, internals.parseOptions);
        ...
        if (internals.dangerouslyDisableValidation !== true) {
            ...
            let validationErrors = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["validate"])(schemaDerivedData.schema, requestContext.document, [
                ...__TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["specifiedRules"],
                ...internals.validationRules
            ], internals.validationOptions);
            if (validationErrors.length === 0 && internals.laterValidationRules) {
                validationErrors = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["validate"])(schemaDerivedData.schema, requestContext.document, internals.laterValidationRules);
            }
    ...
    const operation = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["getOperationAST"])(requestContext.document, request.operationName);
...
const NoIntrospection = (context)=>({
        Field (node) {
            if (node.name.value === '__schema' || node.name.value === '__type') {
                context.reportError(new __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLError"]('GraphQL introspection is not allowed by Apollo Server, but the query contained __schema or __type. To enable introspection, pass introspection: true to ApolloServer in production', {
                    nodes: [
                        node
                    ],
                    extensions: {
...
class RecursiveSelectionValidationContext {
    ...
    reportError(operation) {
        ...
        this.context.reportError(new __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLError"](`${operationName} recursively requests too many selections.`, {
            nodes: [],
            extensions: {
...
class ApolloServer {
    ...
    static generateSchemaDerivedData(schema, providedDocumentStore) {
        (0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["assertValidSchema"])(schema);
        return {
            schema,
            ...
            documentStoreKeyPrefix: providedDocumentStore ? `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$utils$2f$computeCoreSchemaHash$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["computeCoreSchemaHash"])((0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["printSchema"])(schema))}:` : ''
        };
    }
    async stop() {
        switch(this.internals.state.phase){
    ...
    async executeHTTPGraphQLRequest({ httpGraphQLRequest, context }) {
        try {
            ...
            if (maybeError instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["GraphQLError"] && maybeError.extensions.code === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$errors$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApolloServerErrorCode"].BAD_REQUEST) {
                try {
    ...
    async executeOperation(request, options = {}) {
        ...
        const graphQLRequest = {
            ...request,
            query: request.query && typeof request.query !== 'string' ? (0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["print"])(request.query) : request.query
        };
...
async function tryToLoadGraphQL17() {
    ...
    const graphql = await Promise.resolve().then(()=>__importStar(__turbopack_context__.r("[externals]/graphql [external] (graphql, cjs)")));
    if (graphql.version === '17.0.0-alpha.9' && 'experimentalExecuteIncrementally' in graphql) {
        graphqlExperimentalExecuteIncrementally = graphql.experimentalExecuteIncrementally;
    } else {
        graphqlExperimentalExecuteIncrementally = null;
...
const lru_cache_1 = __turbopack_context__.r("[project]/node_modules/lru-cache/dist/commonjs/index.min.js [app-route] (ecmascript)");
...
exports.packageVersion = "5.5.0"; //# sourceMappingURL=packageVersion.js.map
}),
...
//# debugId=8f765eb2-09da-8c36-04da-b1c6c1b3dfb7
