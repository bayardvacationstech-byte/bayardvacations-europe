;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="702c841d-0cc8-b81c-1d70-25e41de218cf")}catch(e){}}();
module.exports = [
"[project]/node_modules/lru-cache/dist/esm/node/index.min.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var D = ()=>S.hasSubscribers || W.hasSubscribers, G = typeof performance == "object" && performance && typeof performance.now == "function" ? performance : Date, M = new Set, C = typeof process == "object" && process ? process : {}, P = (u, e, t, i)=>{
    typeof C.emitWarning == "function" ? C.emitWarning(u, e, t, i) : console.error(`[${t}] ${e}: ${u}`);
}, H = (u)=>!M.has(u), $ = Symbol("type"), F = (u)=>!!u && u === Math.floor(u) && u > 0 && isFinite(u), U = (u)=>F(u) ? u <= Math.pow(2, 8) ? Uint8Array : u <= Math.pow(2, 16) ? Uint16Array : u <= Math.pow(2, 32) ? Uint32Array : u <= Number.MAX_SAFE_INTEGER ? O : null : null, O = class extends Array {
    constructor(e){
        super(e), this.fill(0);
    }
}, R = class u {
    ...
    *rvalues() {
    ...
    dump() {
        ...
        for (let t of this.#A({
            ...
            this.#_ && (o.size = this.#_[t]), e.unshift([
                i,
                o
            ]);
        }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lru$2d$cache$2f$dist$2f$esm$2f$node$2f$index$2e$min$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/lru-cache/dist/esm/node/index.min.js [app-route] (ecmascript)");
;
;
;
;
function ApolloServerPluginCacheControl(options = Object.create(null)) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$internalPlugin$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["internalPlugin"])({
        ...
        async serverWillStart ({ schema }) {
            typeAnnotationCache = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lru$2d$cache$2f$dist$2f$esm$2f$node$2f$index$2e$min$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LRUCache"]({
                max: Object.values(schema.getTypeMap()).filter(__TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["isCompositeType"]).length
            });
            fieldAnnotationCache = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lru$2d$cache$2f$dist$2f$esm$2f$node$2f$index$2e$min$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LRUCache"]({
                max: Object.values(schema.getTypeMap()).filter(__TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["isObjectType"]).flatMap((t)=>Object.values(t.getFields())).length + Object.values(schema.getTypeMap()).filter(__TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["isInterfaceType"]).flatMap((t)=>Object.values(t.getFields())).length
            });
            return undefined;
        },
                ...
                async executionDidStart () {
                    ...
                    return {
                        willResolveField ({ info }) {
                            ...
                            const targetType = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["getNamedType"])(info.returnType);
                            if ((0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["isCompositeType"])(targetType)) {
                            ...
                            return ()=>{
                                if (fieldPolicy.maxAge === undefined && ((0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["isCompositeType"])(targetType) && !inheritMaxAge || !info.path.prev)) {
                                    fieldPolicy.restrict({
                                        maxAge: defaultMaxAge
                                    });
                                }
                                if (__testing__cacheHints && isRestricted(fieldPolicy)) {
                                    const path = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$graphql__$5b$external$5d$__$28$graphql$2c$__cjs$29$__["responsePathAsArray"])(info.path).join('.');
...
//# debugId=702c841d-0cc8-b81c-1d70-25e41de218cf
//# sourceMappingURL=node_modules_f2d96ffe._.js.map